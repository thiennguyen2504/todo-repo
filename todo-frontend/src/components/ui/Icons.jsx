...
/**
 * Lucide-style outline icons — consistent 24×24 viewBox, stroke-based.
 * Only the icons actually needed by the app are included.
 */
...
export function IconClipboard({ size = 48, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor"
...
export function IconCheckSquare({ size = 20, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor"
      strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}
      aria-hidden="true">
